...
const OtherSetting = () => {
  ...
  const openGitHubRelease = () => {
    window.location =
      'https://github.com/yeying-community/router/releases/latest';
  };
    ...
    <Grid columns={1}>
      <Grid.Column>
        <Form loading={loading}>
          ...
          <Form.Group widths='equal'>
            <Form.Input
              label={<label>主题名称（<Link
                to='https://github.com/yeying-community/router/blob/main/web/README.md'>当前可用主题</Link>）</label>}
              placeholder='请输入主题名称'
              value={inputs.Theme}
              name='Theme'
              onChange={handleInputChange}
          ...
          <Message>移除 Router 的版权标识必须首先获得授权，项目维护需要花费大量精力，如果本项目对你有意义，请主动支持本项目。</Message>
          <Form.Group widths='equal'>
            <Form.Input
              label='页脚'
